...
func NewGUIHandler(fetcher ConvoyFetcher) (*GUIHandler, error) {
	...
	h.mux.HandleFunc("/cicd", h.handleCICD)
	...
	h.mux.HandleFunc("/api/health", h.handleAPIHealth)
	...
	h.mux.HandleFunc("/api/mail/view", h.handleAPIMailAgentView)
	...
	h.mux.HandleFunc("/api/cli/usage", h.handleAPICLIUsage)
	h.mux.HandleFunc("/api/cli/limits", h.handleAPICLILimits)
	...
	h.mux.HandleFunc("/api/prompts/claude", h.handleAPIPromptClaude)
	h.mux.HandleFunc("/api/prompts/templates", h.handleAPIPromptTemplates)
